...
class Dictionary {
  public:
    ...
    void addKmers(unsigned, int64_t&, unsigned, std::string, std::string);
    void addCells(unsigned, int64_t&, std::string);
    void addBatches(unsigned, int64_t&, std::string);
    void CreateForCellSpace(std::shared_ptr<DataParser>);
